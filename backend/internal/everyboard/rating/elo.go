...
func ComputeAndUpdateElos(store store.EloStore, gameName string, winner model.MinimalUser, loser model.MinimalUser, draw bool) error {
	...
	return store.UpdateElos(gameName, winner, newEloWinner, loser, newEloLoser)
}
