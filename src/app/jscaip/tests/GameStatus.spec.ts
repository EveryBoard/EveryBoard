...
describe('GameStatus', () => {
    ...
    it('should be convertible to BoardValue', () => {
        expect(GameStatus.ZERO_WON.toBoardValue().metrics).toEqual([BoardValue.getVictoryValueOf(Player.ZERO)]);
        expect(GameStatus.ONE_WON.toBoardValue().metrics).toEqual([BoardValue.getVictoryValueOf(Player.ONE)]);
