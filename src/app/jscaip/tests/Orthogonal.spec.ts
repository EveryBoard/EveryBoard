    ...
    describe('factory', () => {
        ...
        describe('of', () => {
            ...
            it('should fail when constructing an invalid orthogonal', () => {
                expect(Orthogonal.factory.from(2, 1)).toEqual(MGPFallible.failure('Invalid x or y in direction construction'));
                expect(Orthogonal.factory.from(1, 1)).toEqual(MGPFallible.failure('Invalid x or y in direction construction'));
            });
