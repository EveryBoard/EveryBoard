...
export abstract class Rules { // TODO: génériser
	...
	public abstract getListMoves<R extends Rules>(n: MNode<R>): MGPMap<Move, GamePartSlice> ;
	...
	public abstract getBoardValue<R extends Rules>(n: MNode<R>): number;
