...
export class RulesFailure {
    ...
    public static readonly MOVE_CANNOT_BE_STATIC: Localized = () => $localize`You must choose different starting and ending coordinates.`; // TODOTODO reformulate cause.. well, its confusant
