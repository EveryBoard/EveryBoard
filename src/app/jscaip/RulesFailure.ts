export class RulesFailure {
    ...
    public static readonly MUST_CLICK_ON_EMPTY_CASE: string= $localize`You must click on an empty case.`;
    ...
    public static readonly MUST_CHOOSE_OWN_PIECE_NOT_EMPTY: string = $localize`You have selected an empty case, you must select one of your own pieces.`;
}
