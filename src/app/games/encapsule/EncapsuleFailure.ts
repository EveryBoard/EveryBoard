...
export class EncapsuleFailure {
    ...
    public static readonly INVALID_PIECE_SELECTED: Localized = () => $localize`You must pick one of your remaining piece or one piece on the board that is the biggest of its square.`;
