...
export class BrandhubTutorial {
    public tutorial: TutorialStep[] = [
        ...
        TutorialStep.anyMove(
            ...
            BrandhubState.getInitialState(),
            BrandhubMove.instanceProvider(new Coord(3, 1), new Coord(1, 1)),
        ...
        TutorialStep.fromMove(
            ...
            [
                BrandhubMove.instanceProvider(new Coord(3, 5), new Coord(2, 5)),
            ],
        ...
        TutorialStep.fromMove(
            ...
            [
                BrandhubMove.instanceProvider(new Coord(2, 1), new Coord(3, 1)),
                BrandhubMove.instanceProvider(new Coord(3, 0), new Coord(3, 1)),
            ],
        ...
        TutorialStep.fromMove(
            ...
            [BrandhubMove.instanceProvider(new Coord(1, 3), new Coord(2, 3))],
        ...
        TutorialStep.fromMove(
            ...
            [BrandhubMove.instanceProvider(new Coord(2, 0), new Coord(2, 2))],
        ...
        TutorialStep.fromMove(
            ...
            [BrandhubMove.instanceProvider(new Coord(3, 6), new Coord(2, 6))],
            $localize`The king is dead, long live the king. Congratulations, you won.`,
            $localize`Failed!`,
        ),
    ];
