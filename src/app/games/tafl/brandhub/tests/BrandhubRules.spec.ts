...
describe('BrandhubRules', () => {
    ...
    it('should allow first move by invader', () => {
        ...
        const state: BrandhubState = BrandhubState.getInitialState(BrandhubRules.DEFAULT_CONFIG);
        ...
        const expectedState: BrandhubState = new BrandhubState(expectedBoard, 1, BrandhubRules.DEFAULT_CONFIG);
    ...
    it('should allow second move by defender', () => {
        ...
        const expectedState: BrandhubState = new BrandhubState(expectedBoard, 2, BrandhubRules.DEFAULT_CONFIG);
        RulesUtils.expectMoveSuccess(rules, state, move, expectedState);
    });
    ...
    it('should allow capturing the king on his throne with 4 soldiers', () => {
        ...
        const state: BrandhubState = new BrandhubState(board, 0, BrandhubRules.DEFAULT_CONFIG);
