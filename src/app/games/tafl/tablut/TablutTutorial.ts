...
export class TablutTutorial extends Tutorial {
    public tutorial: TutorialStep[] = [
        ...
        TutorialStep.fromMove(
            ...
            $localize`All pieces, attackers and defenders, except the king, are soldiers. To capture them, they have to be sandwiched between two of your pieces. By getting too close, an attacker's soldier is in danger.<br/><br/>You're playing Light, capture Dark's soldier.`,
            new TablutState([
                [_, _, _, x, x, x, _, _, _],
                [_, _, _, _, x, _, _, _, _],
                [_, _, _, _, i, _, _, _, _],
        ...
        TutorialStep.fromMove(
            ...
            $localize`A second way to capture a soldier is to sandwich it against an empty throne. The king has moved and endangered one of its soldiers.<br/><br/>You're playing Dark, capture Light's soldier.`,
            new TablutState([
                [_, _, _, x, x, x, _, _, _],
                [_, _, _, _, x, _, _, _, _],
                [_, _, _, _, i, _, _, _, _],
