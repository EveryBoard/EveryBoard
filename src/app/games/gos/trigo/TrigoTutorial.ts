...
export class TrigoTutorial extends Tutorial {
    ...
    public tutorial: TutorialStep[] = [
        ...
        TutorialStep.informational(
            ...
            $localize`Since it is triangular, pieces have only two freedoms on the edges.<br/> When pieces touch the board's edge with their corner only, like the pieces on the right, they're not really on the edges.`,
            new GoState([
                [N, N, N, N, N, N, _, N, N, N, N, N, N],
        ...
        TutorialStep.informational(
            ...
            $localize`Since it is triangular, pieces have three freedoms when they don't touch the edge.`,
            new GoState([
                [N, N, N, N, N, N, _, N, N, N, N, N, N],
                [N, N, N, N, N, _, _, _, N, N, N, N, N],
        ...
        TutorialStep.informational(
            ...
            $localize`Since it is triangular, groups of two pieces have only one more freedom (making an atari a shisho by default).`,
            new GoState([
