...
export class HexagonalGoTutorial extends Tutorial {
    ...
    public tutorial: TutorialStep[] = [
        TutorialStep.informational(
            ...
            $localize`The game of HexagonalGo is a triangular adaptation of the game of Go. Go is present on Everyboard, you can go learn it <a href="/tutorial/Go">here<a/>. This tutorial will only review the small differences that this experimental adaptation induced.`,
