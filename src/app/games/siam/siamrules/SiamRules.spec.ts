...
describe('SiamRules:', () => {
    ...
    it('Insertion should work', () => {
        ...
        const move: SiamMove = new SiamMove(-1, 4, Orthogonale.RIGHT, Orthogonale.RIGHT);
    ...
    it('Simple forwarding should work', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(2, 4, Orthogonale.UP, Orthogonale.UP);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeTruthy("Move should be legal");
        const resultingSlice: SiamPartSlice = rules.applyLegalMove(move, slice, status).resultingSlice;
        const expectedSlice: SiamPartSlice = new SiamPartSlice(expectedBoard, 1);
    ...
    it('Side pushing should work', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 4, Orthogonale.UP, Orthogonale.UP);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeTruthy("Move should be legal");
        const resultingSlice: SiamPartSlice = rules.applyLegalMove(move, slice, status).resultingSlice;
        const expectedSlice: SiamPartSlice = new SiamPartSlice(expectedBoard, 1);
    ...
    it('Rotation should work', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 4, null, Orthogonale.RIGHT);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeTruthy("Move should be legal");
        const resultingSlice: SiamPartSlice = rules.applyLegalMove(move, slice, status).resultingSlice;
        const expectedSlice: SiamPartSlice = new SiamPartSlice(expectedBoard, 1);
    ...
    it('Half turn rotation should work', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 4, null, Orthogonale.DOWN);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeTruthy("Move should be legal");
        const resultingSlice: SiamPartSlice = rules.applyLegalMove(move, slice, status).resultingSlice;
        const expectedSlice: SiamPartSlice = new SiamPartSlice(expectedBoard, 1);
    ...
    it('Rotation should work while forwarding', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 4, Orthogonale.UP, Orthogonale.DOWN);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeTruthy("Move should be legal");
        const resultingSlice: SiamPartSlice = rules.applyLegalMove(move, slice, status).resultingSlice;
        const expectedSlice: SiamPartSlice = new SiamPartSlice(expectedBoard, 1);
    ...
    it('Moving in a direction different from the piece should be legal', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 4, Orthogonale.RIGHT, Orthogonale.LEFT);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeTruthy("Move should be legal");
        const resultingSlice: SiamPartSlice = rules.applyLegalMove(move, slice, status).resultingSlice;
        const expectedSlice: SiamPartSlice = new SiamPartSlice(expectedBoard, 1);
    ...
    it('One vs one push should not work even if one of the involved is at the border', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 3, Orthogonale.DOWN, Orthogonale.DOWN);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeFalsy("Move should be illegal");
    });
    ...
    it('Pushing while changing direction should be impossible', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 4, Orthogonale.UP, Orthogonale.LEFT);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeFalsy("Move should be illegal");
    });
    it('6 insertion should be impossible', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, -1, Orthogonale.DOWN, Orthogonale.DOWN);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeFalsy("Move should be illegal");
    });
    it('Pushing several mountains should be illegal', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(0, 2, Orthogonale.RIGHT, Orthogonale.RIGHT);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeFalsy("Move should be illegal");
    });
    ...
    it('Player 0 pushing player 0 pushing mountain should be a victory for player 0', () => {
        ...
        const slice: SiamPartSlice = new SiamPartSlice(board, 0);
        const move: SiamMove = new SiamMove(2, 2, Orthogonale.UP, Orthogonale.UP);
        const status: SiamLegalityStatus = rules.isLegal(move, slice);
        expect(status.legal).toBeTruthy("Move should be legal");
        const resultingSlice: SiamPartSlice = rules.applyLegalMove(move, slice, status).resultingSlice;
        const expectedSlice: SiamPartSlice = new SiamPartSlice(expectedBoard, 1);
