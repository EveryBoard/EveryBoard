import { CoerceoNormalMove, CoerceoTileExchangeMove } from 'src/app/games/coerceo/CoerceoMove';
...
export class CoerceoTutorial extends Tutorial {
    ...
    public tutorial: TutorialStep[] = [
        ...
        Perform any move.`,
            CoerceoState.getInitialState(),
            CoerceoNormalMove.of(new Coord(3, 5), new Coord(5, 5)),
        ...
        You're playing Light, make a capture.`,
            ...
            [
                CoerceoNormalMove.of(new Coord(5, 2), new Coord(4, 1)),
                CoerceoNormalMove.of(new Coord(3, 4), new Coord(4, 3)),
            ],
        ...
        You're playing Dark, perform a move that lets you gain two tiles.`,
            ...
            [
                CoerceoNormalMove.of(new Coord(2, 6), new Coord(4, 6)),
                CoerceoNormalMove.of(new Coord(2, 6), new Coord(3, 5)),
                CoerceoNormalMove.of(new Coord(2, 6), new Coord(3, 7)),
            ],
            $localize`Congratulations!`,
        ...
        A move that demonstrates both of these things can be done on this board by Light. Try it!`,
            ...
            [
                CoerceoNormalMove.of(new Coord(7, 6), new Coord(6, 5)),
                CoerceoNormalMove.of(new Coord(7, 6), new Coord(8, 5)),
            ],
