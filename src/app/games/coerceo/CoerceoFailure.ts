export class CoerceoFailure {
    ...
    public static CANNOT_LAND_ON_ALLY: string = $localize`Vous ne pouvez pas déplacer vos pièces sur vos propres pièces.`;

    public static MUST_CHOOSE_OWN_PIECE_NOT_EMPTY: string = $localize`Vous avez sélectionné une case vide, vous devez sélectionner l'une de vos pièces.`
