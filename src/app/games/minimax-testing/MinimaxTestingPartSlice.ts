...
export class MinimaxTestingPartSlice extends GamePartSlice {
    ...
    public static BOARD_0: ReadonlyArray<ReadonlyArray<number>> = [ // le premier joueur gagne, m�me minimax avec depth=1
        [ 7, 4, 3, 1],
        [ 4, 4, 3, 1],
        [ 3, 3, 2, 0],
        [ 1, 1, 0, 0]
    ];
    public static BOARD_1: ReadonlyArray<ReadonlyArray<number>> = [ // le premier joueur gagne, m�me minimax avec depth=1
