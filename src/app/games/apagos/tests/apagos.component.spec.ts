...
describe('ApagosComponent', () => {
    ...
    describe('Dynamic display', () => {
        ...
        it('should show from where the last transfer down came from', fakeAsync(async() => {
            ...
            // Then the landing piece should be of player0 with last move class, and should appear in piece 0
            componentTestUtils.expectElementToHaveClass('#square_0_piece_0_out_of_7', 'player0');
            componentTestUtils.expectElementToHaveClass('#square_0_piece_0_out_of_7', 'last-move');
            // and piece 1 should contain player1
            componentTestUtils.expectElementToHaveClass('#square_0_piece_1_out_of_7', 'player1');

            // and in left square piece 0 should still be of player0
            componentTestUtils.expectElementToHaveClass('#square_3_piece_0_out_of_3', 'player0');
            // and piece 1 should be "captured" as a left piece, belonging to no one
            ...
            // then piece 2 should still be player1
            componentTestUtils.expectElementToHaveClass('#square_3_piece_2_out_of_3', 'player1');
        }));
    });
    describe('Static display', () => {
        it('should drop piece on the first empty space in a square when clicking on an arrow');
        it('');
    });
});
