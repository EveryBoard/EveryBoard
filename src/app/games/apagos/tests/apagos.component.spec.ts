...
describe('ApagosComponent', () => {
    ...
    describe('first click', () => {
        ...
        it('should cancel move when starting move attempt by clicking a square without pieces of player', fakeAsync(async() => {
            ...
            await testUtils.expectClickFailure('#square-2', reason);
        }));
        ...
        it('should drop when clicking on arrow above square', fakeAsync(async() => {
            ...
            await testUtils.expectMoveSuccess('#drop-arrow-one-1', move);
        }));
        ...
        it('should select piece when clicking on square and show only legal following slide', fakeAsync(async() => {
            ...
            await testUtils.expectClickSuccess('#square-2');

            // Then only "Player.ZERO drop" on square 1 should be displayed
            testUtils.expectElementNotToExist('#drop-arrow-zero-0');
            testUtils.expectElementNotToExist('#drop-arrow-one-0');
            testUtils.expectElementToExist('#drop-arrow-zero-1'); // all but this one
            testUtils.expectElementNotToExist('#drop-arrow-one-1');
            testUtils.expectElementNotToExist('#drop-arrow-zero-2');
            testUtils.expectElementNotToExist('#drop-arrow-one-2');
            testUtils.expectElementNotToExist('#drop-arrow-zero-3');
            testUtils.expectElementNotToExist('#drop-arrow-one-3');
            // and square 2 should be selected
            testUtils.expectElementToHaveClass('#square-2', 'selected-stroke');
            testUtils.expectElementToHaveClass('#square-2-piece-1-out-of-3', 'selected-stroke');
        }));
        ...
        it('should not allow to select leftmost space for transfer', fakeAsync(async() => {
            ...
            await testUtils.expectClickFailure('#square-1', reason);
        }));
        ...
        it('should hide last move when doing first click', fakeAsync(async() => {
            ...
            testUtils.expectElementNotToHaveClass('#square-3-piece-0-out-of-1', 'last-move-stroke');
        }));
    ...
    describe('second click', () => {
        ...
        it('should confirm slide down by clicking on a dropping arrow', fakeAsync(async() => {
            ...
            await testUtils.expectMoveSuccess('#drop-arrow-zero-1', move);
        }));
        ...
        it('should cancel move when clicking on a square for the second time', fakeAsync(async() => {
            ...
            await testUtils.expectClickFailure('#square-2');

            // Then the piece should have lost its selected style
            testUtils.expectElementNotToHaveClass('#square-2', 'selected-stroke');
        }));
        ...
        it('should change selected square when clicking on a square with one already selected', fakeAsync(async() => {
            ...
            await testUtils.expectClickSuccess('#square-1');
        }));
        ...
        it('should show all drop arrows after canceling a transfer', fakeAsync(async() => {
            ...
            await testUtils.setupState(state);
            testUtils.expectElementToExist('#drop-arrow-zero-0');
            testUtils.expectElementToExist('#drop-arrow-one-0');
            await testUtils.expectClickSuccess('#square-2');
            testUtils.expectElementToExist('#drop-arrow-zero-0');
            testUtils.expectElementNotToExist('#drop-arrow-one-0');
    ...
    describe('show last move', () => {
        ...
        it('should show only legal drop arrows', fakeAsync(async() => {
            ...
            testUtils.expectElementToExist('#drop-arrow-zero-0');
            testUtils.expectElementToExist('#drop-arrow-one-0');
            testUtils.expectElementToExist('#drop-arrow-zero-1');
            testUtils.expectElementToExist('#drop-arrow-one-1');
            testUtils.expectElementToExist('#drop-arrow-zero-2');
            testUtils.expectElementToExist('#drop-arrow-one-2');
        ...
        it('should show switched squares', fakeAsync(async() => {
            ...
            testUtils.expectElementToHaveClass('#square-1', 'last-move-stroke');
            testUtils.expectElementToHaveClass('#square-2', 'last-move-stroke');
        }));
        ...
        it('should show from where the last transfer came from Player.ZERO', fakeAsync(async() => {
            ...
            testUtils.expectElementNotToHaveClass('#square-3-piece-2-out-of-5', 'player0-fill');
            testUtils.expectElementNotToHaveClass('#square-3-piece-2-out-of-5', 'player1-fill');
            testUtils.expectElementToHaveClass('#square-3-piece-2-out-of-5', 'captured-stroke');
            // and piece 3 should be untouched
            testUtils.expectElementToHaveClass('#square-3-piece-3-out-of-5', 'player1-fill');
        }));
        ...
        it('should show from where the last transfer came from Player.ONE', fakeAsync(async() => {
            ...
            testUtils.expectElementNotToHaveClass('#square-3-piece-3-out-of-5', 'player0-fill');
            testUtils.expectElementNotToHaveClass('#square-3-piece-3-out-of-5', 'player1-fill');
            testUtils.expectElementToHaveClass('#square-3-piece-3-out-of-5', 'captured-stroke');
        }));
        ...
        it('should show last dropped piece (from drop by Player.ZERO)', fakeAsync(async() => {
            ...
            testUtils.expectElementToHaveClass('#square-3-piece-0-out-of-1', 'player0-fill');
        }));
        ...
        it('should show last dropped piece (from drop on righmost coord)', fakeAsync(async() => {
            ...
            // Then the third square should be filled on top by Player.ZERO
            testUtils.expectElementToHaveClass('#square-3-piece-0-out-of-1', 'last-move-stroke');
        }));
        ...
        it('should show last dropped piece (from transfer by Player.ONE)', fakeAsync(async() => {
            ...
            testUtils.expectElementToHaveClass('#square-1-piece-4-out-of-5', 'player1-fill');
            testUtils.expectElementToHaveClass('#square-1-piece-4-out-of-5', 'last-move-stroke');
        }));
    ...
    describe('visuals', () => {
        ...
        it('should not show arrow when player has no longer pieces', fakeAsync(async() => {
            ...
            testUtils.expectElementNotToExist('#drop-arrow-zero-0');
            testUtils.expectElementNotToExist('#drop-arrow-one-0');
            testUtils.expectElementNotToExist('#drop-arrow-zero-1');
            testUtils.expectElementNotToExist('#drop-arrow-one-1');
            testUtils.expectElementNotToExist('#drop-arrow-zero-2');
            testUtils.expectElementNotToExist('#drop-arrow-one-2');
            testUtils.expectElementNotToExist('#drop-arrow-zero-3');
