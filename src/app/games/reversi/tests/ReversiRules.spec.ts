...
describe('ReversiRules', () => {
    ...
    describe('Endgames', () => {
        it('Should consider the player with the more point the winner at the end', () => {
            ...
            expectToBeVictoryFor(rules, new MGPNode(MGPOptional.empty(), move, expectedState), Player.ONE, minimaxes);
        });
        it('Should consider the player with the more point the winner at the end (Player.ZERO remix)', () => {
            ...
            expect(resultingState).toEqual(expectedState);
            expectToBeVictoryFor(rules, new MGPNode(MGPOptional.empty(), move, expectedState), Player.ZERO, minimaxes);
        });
