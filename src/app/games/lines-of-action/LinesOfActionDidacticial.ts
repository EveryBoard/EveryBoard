...
export const linesOfActionDidacticial: DidacticialStep[] = [
    DidacticialStep.informational(
        ...
        contigues, orthogonalement et/ou diagonalement. Ici, Foncé gagne la partie: ses
        pièces ne forment qu'un seul groupe, alors que les pièces de Clair forment trois groupes.`,
