                                                               ...
                                                               PentagoLegalityStatus>
{
    ...
    constructor(messageDisplayer: MessageDisplayer) {
        ...
        this.BLOCK_WIDTH = (3 * this.SQUARE_SIZE) + (2 * this.STROKE_WIDTH);
        this.BLOCK_SEPARATION = (this.BLOCK_WIDTH + 2 * this.STROKE_WIDTH);
        this.DIAGONAL_BAR_OFFSET = Math.cos(Math.PI / 4) * 0.75 * this.SQUARE_SIZE;
    ...
    private generateArrowsCoord(): [string, number, boolean][] {
        ...
        const C: number = this.SQUARE_SIZE;
        const c: number = 0.5 * this.SQUARE_SIZE;
        return [
    ...
    public getCenter(xOrY: number): number {
        ...
        return block + (2 * this.STROKE_WIDTH) + (((xOrY % 3) + 0.5) * this.SQUARE_SIZE);
    }
