...
export class SixState extends GameState implements ComparableObject {
    ...
    public static getInitialState(): SixState {
        // VERTICAL const board: NumberTable = [[Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value], [Player.ZERO.value], [Player.ONE.value]];
        // DIAG const board: NumberTable = [[Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value, Player.ZERO.value, Player.ONE.value]];
