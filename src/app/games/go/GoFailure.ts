export class GoFailure {
    ...
    public static readonly CANNOT_PASS_AFTER_PASSED_PHASE: string = $localize`We are in counting phase, you must mark stones as dead or alive or accept current board.`;
