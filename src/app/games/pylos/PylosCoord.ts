...
export class PylosCoord extends Coord3D {
    ...
    public static override encoder: Encoder<PylosCoord> = Coord3D.getEncoder(PylosCoord.from);

    public static override optionalEncoder: Encoder<MGPOptional<PylosCoord>> =
        MGPOptional.getEncoder(PylosCoord.encoder);
