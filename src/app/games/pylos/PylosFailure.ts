export class PylosFailure {
    ...
    public static readonly SHOULD_START_FROM_PLAYER_PIECE: string = $localize`You must start your move from one of your pieces.`;

    public static readonly SHOULD_HAVE_SUPPORTING_PIECES: string = $localize`Your move must have supporting pieces.`;

    public static readonly CANNOT_LAND: string = $localize`You cannot land of this space.`;
