...
describe('GipfPartSlice', () => {
    ...
    describe('some slice', () => {
        ...
        it('should have one double pieces for each player', () => {
    ...
    it('should distinguish different slices', () => {
        ...
        const slice1: GipfPartSlice = new GipfPartSlice(board1, 6,
                                                        [5, 5], [false, false], [0, 0]);
        ...
        const slice2: GipfPartSlice = new GipfPartSlice(board2, 6,
                                                        [5, 5], [false, false], [0, 0]);
