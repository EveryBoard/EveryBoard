export class GipfFailure {
    ...
    public static readonly PLACEMENT_WITHOUT_DIRECTION: string = $localize`You must select a placement alongside the insertion space.`;
    ...
    public static readonly CLICK_FURTHER_THAN_ONE_COORD: string = $localize`You must select a destination space at a distance of 1 from the entrance.`;
