export class EpaminondasFailure {
    ...
    public static readonly CASE_NOT_ALIGNED_WITH_SELECTED: string = $localize`This square is not aligned with the selected piece.`;

    public static readonly SINGLE_PIECE_MUST_MOVE_BY_ONE: string = $localize`A single piece can only move by one square.`;

    public static readonly SINGLE_PIECE_CANNOT_CAPTURE: string = $localize`A single piece cannot make a capture.`;

    public static readonly CASE_NOT_ALIGNED_WITH_PHALANX: string = $localize`This square is not aligned with the direction of the phalanx.`;
