...
describe('KamisadoRules:', () => {
    ...
    it('should detect winning board for each player', () => {
        ...
        const node1: KamisadoNode = new KamisadoNode(state1, null, KamisadoMove.PASS);
        ...
        const node2: KamisadoNode = new KamisadoNode(state2, null, KamisadoMove.PASS);
        ...
        const node3: KamisadoNode = new KamisadoNode(state3, null, KamisadoMove.PASS);
        ...
        const node4: KamisadoNode = new KamisadoNode(state4, null, KamisadoMove.PASS);
