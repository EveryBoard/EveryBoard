...
//             const move: CheckersMove = CheckersMove.fromStep(new Coord(1, 3), new Coord(2, 2)).get();
...
//             const move: CheckersMove = CheckersMove.fromStep(new Coord(0, 2), new Coord(1, 3)).get();
...
//             const move: CheckersMove = CheckersMove.fromStep(new Coord(1, 5), new Coord(2, 6)).get();
...
//             const move: CheckersMove = CheckersMove.fromStep(new Coord(5, 5), new Coord(4, 4)).get();
...
//             const move: CheckersMove = CheckersMove.fromStep(new Coord(2, 4), new Coord(3, 3)).get();
...
//             const captures: Coord[] = [new Coord(2, 2), new Coord(0, 4), new Coord(2, 6)];
...
//             const move: CheckersMove = CheckersMove.fromStep(new Coord(2, 2), new Coord(3, 3)).get();
...
//             const move: CheckersMove = CheckersMove.fromStep(new Coord(1, 1), new Coord(0, 0)).get();
