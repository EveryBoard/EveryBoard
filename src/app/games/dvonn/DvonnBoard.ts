...
export class DvonnBoard extends HexaBoard<DvonnPieceStack> { // TODO: make hexaboard a GameState child, don't merge that!
    ...
    public constructor(public readonly board: Table<DvonnPieceStack>) {
        super(board, DvonnBoard.WIDTH, DvonnBoard.HEIGHT, DvonnBoard.EXCLUDED_CASES, DvonnPieceStack.EMPTY);
    }
