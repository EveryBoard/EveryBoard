        ...
        for (const switchTo2D of [false, true]) {
            ...
            describe(name, () => {
                ...
                it('should create a third level', fakeAsync(async() => {
                    ...
                    const NOMAJ1: TrexoPieceStack = TrexoPieceStack.from([
                        new TrexoPiece(Player.ONE, 1, 0),
                        new TrexoPiece(Player.ZERO, 2, 3),
                    ]);
                    const NOMAJ2: TrexoPieceStack = TrexoPieceStack.from([
                        new TrexoPiece(Player.ZERO, 1, 1),
                        new TrexoPiece(Player.ONE, 2, 2),
                    ]);
                    const NOMAJ3: TrexoPieceStack = TrexoPieceStack.from([
                    ...
                    const state: TrexoState = TrexoState.from([
                        ...
                        [______, ______, ______, ______, ______, ______, ______, ______, ______, ______],
                        [______, ______, ______, ______, ______, ______, ______, ______, ______, ______],
                        [______, ______, ______, ______, NOMAJ0, NOMAJ2, ______, ______, ______, ______],
                        [______, ______, ______, ______, NOMAJ1, NOMAJ3, ______, ______, ______, ______],
                        [______, ______, ______, ______, ______, ______, ______, ______, ______, ______],
                        [______, ______, ______, ______, ______, ______, ______, ______, ______, ______],
                        [______, ______, ______, ______, ______, ______, ______, ______, ______, ______],
                        [______, ______, ______, ______, ______, ______, ______, ______, ______, ______],
