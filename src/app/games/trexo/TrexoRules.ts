...
export class TrexoRules extends ConfiglessRules<TrexoMove, TrexoState> {
    ...
    public applyLegalMove(move: TrexoMove, state: TrexoState, _config: MGPOptional<EmptyRulesConfig>, _info: void)
    : TrexoState
    {
        return state
