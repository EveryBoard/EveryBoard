...
import { DraughtRules } from '../DraughtRules';
import { DraughtTutorial } from '../DraughtTutorial';

describe('NewGameComponent', () => {
    let testUtils: ComponentTestUtils<DraughtComponent>;
    ...
    beforeEach(fakeAsync(async() => {
        ...
        spyOn(GameInfo, 'ALL_GAMES').and.returnValue([
            new GameInfo('New Game', 'NewGame', DraughtComponent, new DraughtTutorial(), DraughtRules.get(), new Date('2018-08-28'), 'This is the one-line description of the game'),
        ]);
        // This `testUtils` will be used throughout the test suites as a matcher for various test conditions
        testUtils = await ComponentTestUtils.forGame<DraughtComponent>('NewGame');
    }));
    it('should create', () => {
    ...
    it('this test is only there to cover new-game remaining functions', fakeAsync(async() => {
        await testUtils.getGameComponent().showLastMove(new DraughtMove());
