 ...
 */
export class DraughtNode extends MGPNode<DraughtRules,
                                         DraughtMove,
                                         DraughtState,
                                         DraughtLegalityInfo,
                                         DraughtBoardValue> {}
 ...
 */
export class DraughtRules extends Rules<DraughtMove, DraughtState, DraughtLegalityInfo, DraughtBoardValue> {
     ...
     */
    public isLegal(move: DraughtMove, state: DraughtState): MGPFallible<DraughtLegalityInfo> {
        return MGPFallible.success(new DraughtLegalityInfo());
    }
    /**
