...
import { DraughtBoardValue, DraughtLegalityInfo, DraughtNode, DraughtRules } from './DraughtRules';
 ...
 */
export class DraughtDummyMinimax extends Minimax<DraughtMove,
                                                 DraughtState,
                                                 DraughtLegalityInfo,
                                                 DraughtBoardValue,
                                                 DraughtRules>
{
     ...
     */
    public getListMoves(node: DraughtNode): DraughtMove[] {
        return [];
    }
    /**
     ...
     */
    public getBoardValue(node: DraughtNode): DraughtBoardValue {
        return new DraughtBoardValue(0);
    }
}
