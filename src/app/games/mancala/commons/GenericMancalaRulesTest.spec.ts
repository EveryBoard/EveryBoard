...
export class MancalaRulesTestEntries<M extends MancalaMove> {
    ...
    minimaxes: Minimax<M, MancalaState>[];
    simpleMove: M;
}
    ...
    describe(entries.gameName + ' component generic tests', () => {
        ...
        describe('getGameStatus', () => {
            it('should identify victory for player 0', () => {
                ...
                const node: AbstractNode = new MGPNode(state);
                // Then it should be a victory for player 0
                RulesUtils.expectToBeVictoryFor(entries.rules, node, Player.ZERO, entries.minimaxes);
            });
            it('should identify victory for player 1', () => {
                ...
                RulesUtils.expectToBeVictoryFor(entries.rules, node, Player.ONE, entries.minimaxes);
            });
            it('should identify draw', () => {
                ...
                RulesUtils.expectToBeDraw(entries.rules, node, entries.minimaxes);
            });
        });
    });
}
