                                       ...
                                       M extends MancalaMove>
{
    ...
    public expectToBeFed(actionAndResult: MancalaActionAndResult<M>, config: MancalaConfig): void {
...
: void
{
    ...
    describe(entries.gameName + ' component generic tests', () => {
        ...
        it('should have a bijective encoder', () => {
            ...
            const minimax: Minimax<M, MancalaState> =
                mancalaTestUtils.testUtils.getGameComponent().availableMinimaxes[0];
            const rulesConfig: MancalaConfig =
                RulesConfigUtils.getGameDefaultConfig(entries.gameName) as MancalaConfig;
            const firstTurnMoves: M[] = minimax.getListMoves(rules.getInitialNode(rulesConfig));
