...
export class KalahTutorial extends Tutorial {
    ...
    public tutorial: TutorialStep[] = [
        ...
        TutorialStep.fromMove(
            ...
            KalahRules.get().getInitialState(defaultConfig),
            [
                MancalaMove.of(MancalaDistribution.of(0, 0)),
                MancalaMove.of(MancalaDistribution.of(1, 0)),
                MancalaMove.of(MancalaDistribution.of(2, 0)),
            ],
        ...
        TutorialStep.fromPredicate(
            ...
            KalahRules.get().getInitialState(defaultConfig),
            MancalaMove.of(MancalaDistribution.of(3, 0), [MancalaDistribution.of(1, 0)]),
        ...
        TutorialStep.fromPredicate(
            ...
            MancalaMove.of(MancalaDistribution.of(1, 0), [MancalaDistribution.of(0, 0), MancalaDistribution.of(3, 0)]),
