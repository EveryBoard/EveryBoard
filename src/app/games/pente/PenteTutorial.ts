...
export class PenteTutorial extends Tutorial {
    public tutorial: TutorialStep[] = [
        ...
        TutorialStep.anyMove(
            ...
            PenteState.getInitialState(),
            PenteMove.from(new Coord(9, 8)).get(),
        ...
        TutorialStep.fromMove(
            ...
            [PenteMove.from(new Coord(9, 6)).get()],
            $localize`Congratulations!`,
        ...
        TutorialStep.fromMove(
            ...
            [PenteMove.from(new Coord(9, 7)).get()],
            $localize`Congratulations!`,
            $localize`Failed. Try again.`,
        ),
        TutorialStep.fromMove(
            ...
            [
                PenteMove.from(new Coord(9, 6)).get(),
                PenteMove.from(new Coord(8, 9)).get(),
                PenteMove.from(new Coord(13, 9)).get(),
            ],
            $localize`Congratulations!`,
            $localize`Failed. Try again.`,
        ),
