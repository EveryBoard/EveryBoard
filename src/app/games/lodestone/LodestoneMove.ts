...
import { LodestoneOrientation } from './LodestonePiece';
...
export class LodestoneMove extends MoveCoord {
    ...
    public static encoder: Encoder<LodestoneMove> = new class extends Encoder<LodestoneMove> {
        ...
        public decode(encoded: JSONValueWithoutArray): LodestoneMove {
            ...
            assert(casted.isPush != null, 'Invalid encoded LodestoneMove');
    ...
    public override toString(): string {
        return `LodestoneMove(${this.coord.toString()}, ${this.isPush}, ${this.orientation}, { top: ${this.captures.top}, bottom: ${this.captures.bottom}, left: ${this.captures.left}, right: ${this.captures.right} })`;
    }
