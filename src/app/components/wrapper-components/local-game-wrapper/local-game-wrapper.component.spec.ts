...
describe('LocalGameWrapperComponent (game phase)', () => {
    ...
    it('connected user should be able to play', fakeAsync(async() => {
        ...
        // When doing a move
        await testUtils.expectMoveSuccess('.click-4', P4Move.of(4));
    ...
    it('should show draw', fakeAsync(async() => {
        ...
        await testUtils.expectMoveSuccess('.click-3', P4Move.of(3));
    ...
    it('should not allow clicks after the end of the game', fakeAsync(async() => {
        ...
        await testUtils.expectMoveSuccess('.click-0', P4Move.of(0));
        // Then it should not be possible to click again
        await testUtils.expectClickFailure('.click-3', GameWrapperMessages.GAME_HAS_ENDED());
    }));
    ...
    describe('Using AI', () => {
        ...
        it('should reject human move if it tries to play when it is not its turn', fakeAsync(async() => {
            ...
            // Then it should fail
            await testUtils.expectClickFailure('.click-3', GameWrapperMessages.NOT_YOUR_TURN());
        }));
