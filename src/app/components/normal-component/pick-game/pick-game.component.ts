...
export class GameInfo {
    ...
    private static fillAllGames(): void {
        GameInfo.ALL_GAMES = [
            ...
            new GameInfo($localize`Zoomed Go`,              'ZoomedGo',              ZoomedGoComponent,              new ZoomedGoTutorial(),              ZoomedGoRules.get(),              new Date('2026-08-10'), GameDescription.ZOOMED_GO()             ), // 44:                             * Martin
