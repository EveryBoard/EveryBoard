...
export class GameInfo {
    ...
    private static fillAllGames(): void {
        GameInfo.ALL_GAMES = [
            ...
            new GameInfo($localize`Connect N`,              'ConnectN',              ConnectNComponent,              new HexagonalGoTutorial(),           ConnectNRules.get(),              new Date('2026-08-15'), GameDescription.HEXAGONAL_GO()          ), // 44:                             * Martin
