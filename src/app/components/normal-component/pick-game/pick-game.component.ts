...
class GameDescription {
    ...
    public static readonly KALAH: Localized = () => $localize`A modern version of the Mancala board game family.`;
...
export class GameInfo {
    ...
    public static ALL_GAMES: () => GameInfo[] = () => [
        ...
        new GameInfo($localize`Kalah`, 'Kalah', KalahComponent, new KalahTutorial(), KalahRules.get(), new Date('2023-08-15'), GameDescription.KALAH()),
