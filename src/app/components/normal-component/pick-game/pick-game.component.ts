...
class GameDescription {
    ...
    public static readonly TREXO: Localized = () => $localize`Align 5 pieces of your color in a row, but beware, the pieces can be put on top of others pieces!`;
...
export class GameInfo {
    ...
    public static ALL_GAMES: () => GameInfo[] = () => [
        ...
        new GameInfo($localize`Trexo`, 'Trexo', TrexoComponent, new TrexoTutorial(), TrexoRules.get(), new Date('2022-12-14'), GameDescription.TREXO()),
