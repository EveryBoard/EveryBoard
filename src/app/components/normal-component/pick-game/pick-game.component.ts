...
export class GameInfo {
    ...
    private static fillAllGames(): void {
        GameInfo.ALL_GAMES = [
            ...
            new GameInfo($localize`Toric Reversi`,          'ToricReversi',          ToricReversiComponent,          new ToricReversiTutorial(),          ToricReversiRules.get(),          new Date('2026-05-14'), GameDescription.TORIC_REVERSI()         ), // 43:                             * Martin
