...
export class GameInfo {
    ...
    public static ALL_GAMES: () => GameInfo[] = () => [
        ...
        new GameInfo($localize`Hive`, 'Hive', HiveComponent, new HiveTutorial(), HiveRules.get(), new Date('2023-02-19'), GameDescription.HIVE()),
        new GameInfo($localize`Lasca`, 'Lasca', LascaComponent, new LascaTutorial(), LascaRules.get(), new Date('2023-02-15'), GameDescription.LASCA()),
