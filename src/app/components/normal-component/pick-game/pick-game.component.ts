...
export class GameInfo {
    ...
    public static ALL_GAMES(): GameInfo[] {
        return [
            ...
            new GameInfo($localize`HexagonalConnection`, 'HexagonalConnection', HexagonalConnectionComponent, new HexagonalConnectionTutorial(), HexagonalConnectionRules.get(), new Date('2024-05-20'), GameDescription.HEXAGONAL_CONNECTION()), //                             * Martin
