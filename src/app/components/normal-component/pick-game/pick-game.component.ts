...
import { ConspirateursState } from 'src/app/games/conspirateurs/ConspirateursState';
...
export class GameInfo {
    ...
    public static ALL_GAMES: () => GameInfo[] = () => [
        ...
        new GameInfo($localize`Siam`, 'Siam', SiamComponent, new SiamTutorial(), new SiamRules(SiamState), new Date('2020-01-11'), GameDescription.SIAM()), // 12 days after Encapsule
