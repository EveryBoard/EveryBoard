...
import { AbstractAI } from '../../../jscaip/AI/AI';
...
export class GameInfo {
    ...
    private static fillAllGames(): void {
        const p4AIList: AbstractAI[] = [
            new P4Minimax(),
        ];
        GameInfo.ALL_GAMES = [
            new GameInfo($localize`Four in a Row`,          'P4',                    P4Component,                    new P4Tutorial(),                    P4Rules.get(),                    new Date('2018-08-28'), GameDescription.P4(),                    p4AIList), //  0:                             * Martin
    ...
    public constructor(public readonly name: string,
                       ...
                       public readonly availableAIList: AbstractAI[] = [],
