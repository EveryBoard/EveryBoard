...
import { EncapsuleFailure } from 'src/app/games/encapsule/encapsule-rules/EncapsuleRules';
...
describe('EncapsuleComponent', () => {
    ...
    beforeEach(fakeAsync(async() => {
        componentTestUtils = new ComponentTestUtils<EncapsuleComponent>('Encapsule');
    }));
    it('should create', () => {
