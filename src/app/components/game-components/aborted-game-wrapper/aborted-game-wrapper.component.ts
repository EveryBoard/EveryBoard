...
//
// export abstract class AbortedGameWrapperComponent implements OnInit, OnDestroy {
//
// 	/************************************************ Common fields ************************************************/
//
...
// 		if (![Number.MAX_SAFE_INTEGER, Number.MIN_SAFE_INTEGER].includes(this.gameComponent.rules.node.getOwnValue())) {
// 			alert('how the fuck did you notice victory?');
// 		}
// 		if (this.gameComponent.rules.node.getOwnValue() === Number.MAX_SAFE_INTEGER) {
