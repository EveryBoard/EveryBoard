...
describe('PartDAO', () => {
        ...
        it('should forbid creator to change typeGame/playerZero/playerOne/beginning once a part has started', async() => {
            ...
            for (const update of updates) {
                ...
                const result: Promise<void> =
                    partService.updateAndBumpIndex(partId, Player.ZERO, PartMocks.INITIAL.lastUpdate.index, update);
                // Then it should fail
                await expectPermissionToBeDenied(result);
            }
        });
    ...
    describe('for player', () => {
        it('should forbid player to change typeGame', async() => {
            ...
            const result: Promise<void> = partService.updateAndBumpIndex(partId,
                                                                         Player.ZERO,
        ...
        it('should allow updates to lastUpdate if it is a +1 increment and matches the player', async() => {
            ...
            const result: Promise<void> =
                    partService.updateAndBumpIndex(partId, Player.ZERO, PartMocks.STARTING.lastUpdate.index, { });
        ...
        it('should forbid updates to lastUpdate if it increments more than once', async() => {
            ...
            const result: Promise<void> =
                    partService.updateAndBumpIndex(partId, Player.ZERO, PartMocks.STARTING.lastUpdate.index + 1, { });
        ...
        it('should forbid updates to lastUpdate for another user', async() => {
            ...
            const result: Promise<void> =
                    partService.updateAndBumpIndex(partId, Player.ONE, PartMocks.STARTING.lastUpdate.index, { });
